...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending }: Props) => {
    ...
    const addTag = () => {
        ...
        if (newTag && !newTagSet.has(newTag)) {
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            />
                                            {
                                                errors.price && (
                                                    <p className="text-red-500 text-sm mt-1">
                                                        El precio del producto es requerido y debe ser mayor a 0
                                                    </p>
                                                )
                                            }
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {
                                                errors.stock && (
                                                    <p className="text-red-500 text-sm mt-1">
                                                        El stock del producto es requerido y debe ser mayor a 0
                                                    </p>
                                                )
                                            }
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            {...register('slug',
                                                {
                                                    required: true,
                                                    validate: (value) => !/\s/.test(value) || 'El slug debe contener solo letras minúsculas, números y guiones',
                                                }
                                            )}
                                            className={
                                                cn(
